...
const TABS_DASHBOARD = {
  resumen:     ['admin','socio','gerente','administrativo','pedidos','personal'],
  ranking:     ['admin','socio','gerente','administrativo','pedidos'],
  costos:      ['admin','socio','gerente'],
  presupuesto: ['admin','socio','gerente'],
  seguimiento: ['admin','socio','gerente','administrativo','pedidos'],
...
module.exports = { ROLES, ROLE_LABELS, PERMS, TABS_DASHBOARD, hasPerm, tabsPermitidas };
