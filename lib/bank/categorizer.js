...
const REGLAS_FISCALES_Y_FIJOS = [
  ...
  { re: /alquiler|arrendamiento|silicius|concepcion\s+orive|real\s+estate|\bsocimi\b|overlease|inmobil|fianza\s+local|fianza|dialque|tgt\s+dialque/i, cat: 'ALQUILER' },
...
const REGLAS_FIN_Y_MANT = [
  ...
  { re: /leroy\s+merlin|leroymerlin|\bbricomart\b|\bbrico\s*depot\b|\bferreteria/i,          cat: 'MANTENIMIENTO' },
...
function categorizarGasto(concepto) {
  ...
  // 2) nómina explícita (palabra "NOMINA" en el concepto) — antes que cualquier otra
