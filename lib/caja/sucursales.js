...
const SUCURSAL_A_SOCIEDAD = {
  ...
  'MURCIA NUEVO':    'murcia',   // = MADERO (display canónico)
  'MADRID':          'alicante',
  'BENIDORM':        'benidorm',
};
...
//
// Actualizado 2026-06-07: MADRID y MURCIA NUEVO salen del set (pasan a
// operativas: Aires Alicante SL y Aires Burger Bar Murcia SL/MADERO).
// IFA queda como interno.
