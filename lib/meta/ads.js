...
async function buildAdsDashboard({ refresh = false } = {}) {
  ...
  // VERSION BUMP cuando cambie el shape: v4 agrega display_name,
  // ads_manager_url, thumbnail_resolved, ig_thumbnail, primary_permalink.
  const cacheKey = `ads_dashboard:v4:${accId}`;
