...
async function buildAdsDashboard({ refresh = false } = {}) {
  ...
  // VERSION BUMP cuando cambie el shape o la semántica: v5 agrega
  // is_delivering (delivery real, no solo effective_status) y
  // recomendaciones SOLO sobre campañas que están entregando.
  const cacheKey = `ads_dashboard:v5:${accId}`;
